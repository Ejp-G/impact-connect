  ...
  if (sent) return (
    <div style={{minHeight:'100vh',background:'linear-gradient(145deg,#072B6A 0%,#0B3D91 100%)',display:'flex',alignItems:'center',justifyContent:'center',padding:24}}>
      <div style={{background:'#fff',borderRadius:24,padding:48,textAlign:'center',maxWidth:400}}>
        ...
        <div style={{color:'var(--gd)',fontSize:14,lineHeight:1.6}}>Votre fiche a ete enregistree. Un membre de notre equipe vous contactera tres prochainement. Dieu vous benisse !</div>
      </div>
    </div>
  )
      ...
      <div style={{background:'#fff',borderRadius:24,padding:'32px 28px',width:'100%',maxWidth:440}}>
        ...
        {step === 0 && (
          <div style={{textAlign:'center'}}>
            ...
            <div style={{fontSize:13,color:'var(--gd)',lineHeight:1.6,marginBottom:28}}>Ce formulaire nous permettra de mieux vous connaitre et de vous accompagner dans votre parcours de foi.</div>
